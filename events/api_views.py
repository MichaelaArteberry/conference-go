...
class ConferencesListEncoder(ModelEncoder):
    model = Conference
    properties = ["name"]

class ConferenceDetailEncoder(ModelEncoder):
    model = Conference
    properties = ["name", "starts", "ends", "description", "created", "updated", "max_presentations", "max_attendees", "location"]
...
def api_show_conference(request, id):
    ...
    if request.method == "Get":
        ...
        return JsonResponse(location, encoder=ConferenceDetailEncoder, safe=False)
        ...
        weather = get_weather(content["location"].city, content["location"].state)
